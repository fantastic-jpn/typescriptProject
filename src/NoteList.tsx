...
export function NoteList({availableTags, notes,onDelete,onUpdate}: NoteListProps){
...
function EditTagsModa({availableTags, handleClose,show, onUpdate, onDelete}: EditTagsModalProps){
